 ...
 */
class Comblock_Auth_Page_Dashboard extends Comblock_Auth_Post_Manager
{
    /**
     * @since 1.0.0
     * @access protected
    ...
    {
        $this->slug = apply_filters('comblock_auth_page_dashboard_slug', 'dashboard');

        $this->args = apply_filters('comblock_auth_page_dashboard_options', [
            'post_name' => $this->slug,
